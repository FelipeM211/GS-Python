README - Projeto GS Python — Provenn
...
O avanço tecnológico trouxe novas formas de trabalho e de recrutamento, mas muitas micro e pequenas empresas ainda têm dificuldade para divulgar vagas e atrair profissionais qualificados.
...
O sistema inicia exibindo o menu de login.

O usuário pode fazer login ou criar uma nova conta.

Após o login, o sistema identifica o tipo de usuário e exibe apenas as opções correspondentes:

Candidato: pode ver empresas e se candidatar.

Empresa: pode ver candidatos e enviar propostas.

O sistema salva automaticamente novos cadastros ou alterações nos arquivos .json.

7. Como Executar

Verifique se o Python 3 está instalado.

Mantenha os arquivos GS.py, empresas.json e candidatos.json na mesma pasta.
...
Siga as instruções no menu do programa.

8. Link do Vídeo

O vídeo demonstra todo o funcionamento do Provenn, incluindo login, cadastro, navegação e envio de candidaturas e propostas.
(Inserir link do YouTube aqui quando disponível.)

9. Conclusão

O Provenn foi desenvolvido para resolver um problema real de empregabilidade e gestão de talentos, oferecendo uma solução prática, leve e totalmente feita em Python.
O projeto mostra a aplicação eficiente de conceitos fundamentais da linguagem e atende integralmente os critérios técnicos e pedagógicos do GS.
